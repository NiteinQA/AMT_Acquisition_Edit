...
public static String get_value_of_frozen_input_field(WebDriver driver, WebElement element) {
		...
		String attribute = js.executeScript("return arguments[0].getAttribute('" + "id" + "');", element).toString();
